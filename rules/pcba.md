...
- **核心目标**：基于 PCBA 工业软件数据构建核心知识图谱，利用 LLM 实现配套的学生学习自动评价、支持学习进度跟踪、薄弱环节识别系统
...
# 编码规范
- 每次进行代码修改后重新检查readme.md和requirements.txt文件，确保所有技术栈、快速开始、API 接口等内容都已更新
- 代码需要有相应注释，包括函数、类、模块等
- **Python**：
